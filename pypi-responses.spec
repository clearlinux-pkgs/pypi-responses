...
Source0  : https://files.pythonhosted.org/packages/ea/d5/a7300764f8350420815b2c1abf30ebb78a7edd6eea586af784babdc2e9b0/responses-0.25.0.tar.gz
...
%prep
%setup -q -n responses-0.25.0
cd %{_builddir}/responses-0.25.0
pushd ..
cp -a responses-0.25.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707926427
