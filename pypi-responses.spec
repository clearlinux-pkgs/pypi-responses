...
Source0  : https://files.pythonhosted.org/packages/81/7e/2345ac3299bd62bd7163216702bbc88976c099cfceba5b889f2a457727a1/responses-0.25.7.tar.gz
...
%prep
%setup -q -n responses-0.25.7
cd %{_builddir}/responses-0.25.7
pushd ..
cp -a responses-0.25.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741743476
