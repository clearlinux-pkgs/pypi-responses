...
Source0  : https://files.pythonhosted.org/packages/5a/00/f0c95461f33b3cf452339f5cd212f653dbaf5caadca6bc7f229531c212c6/responses-0.23.3.tar.gz
...
%prep
%setup -q -n responses-0.23.3
cd %{_builddir}/responses-0.23.3
pushd ..
cp -a responses-0.23.3 buildavx2
popd
